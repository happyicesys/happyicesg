...
get('/market/customer/notify/{customer_id}', 'MarketingController@notifyManagerIndex');
post('/market/customer/notify/{customer_id}', 'MarketingController@storeNotification');
delete('/market/customer/notify/{notification_id}', 'MarketingController@destroyNotification');
...
get('/recruitment', 'ClientController@recruitmentIndex');
get('/vending', 'ClientController@vendingIndex');

    ...
    <div class="panel-body">
        ...
        <div class="table-responsive" id="exportable">
            <table class="table table-list-search table-hover table-bordered">
                ...
                <tbody>
                    <tr dir-paginate="transaction in transactions | filter:search | orderBy:sortType:sortReverse | itemsPerPage:itemsPerPage1" pagination-id="custtrans" current-page="currentPage1" ng-controller="repeatController1">
        ...
        <div class="panel-footer">
              <dir-pagination-controls max-size="5" pagination-id="custtrans" direction-links="true" boundary-links="true" class="pull-left"> </dir-pagination-controls>
        </div>
</div>
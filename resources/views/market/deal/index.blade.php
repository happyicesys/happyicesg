...
@section('content')
    ...
    <div class="panel panel-warning" ng-app="app" ng-controller="transController">

        <div class="panel-heading">

            <ul class="nav nav-pills nav-justified" role="tablist">

                <li class="active"><a href="#deal" role="tab" data-toggle="tab"> Deals</a></li>

                {{-- <li><a href="#commision" role="tab" data-toggle="tab"> Commision</a></li> --}}

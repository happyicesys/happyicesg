...
<div class="create_edit" ng-app="app" ng-controller="dealsController">
    <div class="panel panel-primary">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><strong>New Commision</strong></h3>
        </div>

        <div class="panel-body">
            {!! Form::model($transaction = new \App\DtdTransaction, ['action'=>'MarketingController@storeCommision']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('person_id',
                                [''=>null] + $people->select(DB::raw("CONCAT(cust_id,' - ',company,' (',name,')') AS full, id"))->whereActive('Yes')->reOrderBy('cust_id', 'asc')->lists('full', 'id')->all(),
                                null,
                                [
                                'id'=>'person_id',
...
<script src="/js/deal_commision.js"></script>
<script>
    $('.select').select2();
</script>

          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select class="select form-control" id="is_inventory4" ng-model="search.is_inventory" ng-change="onProductTypeSelected()">
                        <option value="1">
                            Inventory Item
                        </option>
                        <option value="">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select class="selectmultiple form-control" id="item_id4" ng-model="search.item_id" ng-change="searchDB()" multiple>

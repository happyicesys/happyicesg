        ...
        <div class="col-md-5 col-sm-5 col-xs-12">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 text-right" style="border: thin black solid">
                    <strong>{{$deals::whereIn('transaction_id', $transactionArr)->sum('amount') }}</strong>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 text-right" style="border: thin black solid">
                    <strong>{{$deals::whereIn('transaction_id', $transactionArr)->sum(DB::raw('qty * unit_cost')) }}</strong>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6">
